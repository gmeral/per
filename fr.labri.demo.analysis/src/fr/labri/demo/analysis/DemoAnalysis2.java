...
public class DemoAnalysis2 extends AbstractAnalysis{
    
	public DemoAnalysis2() {
		super();		
	}

	public DemoAnalysis2(AnalysisConfiguration config, Dao dao, Properties properties) {
